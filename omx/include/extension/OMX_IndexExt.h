...
typedef enum OMX_INDEXEXTTYPE {
  ...
  OMX_IndexExtAudioGetProfile,
  OMX_IndexExtAudioGetLevel,
  ...
  OMX_IndexExtVideoHeadBitrate,
  OMX_IndexExtVideoMediaType,
  OMX_IndexExtVideoProfile,
  OMX_IndexExtVideoGopBitrate,
  OMX_IndexExtVideoGopQP,
  ...
  //for VideoProperties
  OMX_IndexConfigVideoProperties,
  OMX_IndexConfigVideoPixelAspectRatio,
  OMX_IndexConfigVideoAFD,
  OMX_IndexConfigVideo3DFormat,
  ...
  OMX_IndexExtTimeClockDisableAVSync,  /**< reference: OMX_IndexExtTimeClockDisableAVSync */
  OMX_IndexExtTimeClockDisableASync,   /**< reference: OMX_IndexExtTimeClockDisableASync */
  OMX_IndexExtTimeClockDisableVSync,   /**< reference: OMX_IndexExtTimeClockDisableVSync */
  OMX_IndexExtTimeClockEnableAVSync,   /**< reference: OMX_IndexExtTimeClockEnableAVSync */
  OMX_IndexExtTimeClockEnableASync,    /**< reference: OMX_IndexExtTimeClockEnableASync */
  OMX_IndexExtTimeClockEnableVSync,    /**< reference: OMX_IndexExtTimeClockEnableVSync */
