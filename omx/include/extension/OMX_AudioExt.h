...
/** Extened RA (Real Audio) params */
typedef struct OMX_AUDIO_PARAM_EXT_RATYPE {
  ...
  OMX_U32 nFlavorIndex;
  OMX_U32 nGranularity;
  OMX_U32 nOpaqueDataSize;
  OMX_U8 nOpaqueData[32];
} OMX_AUDIO_PARAM_EXT_RATYPE;
