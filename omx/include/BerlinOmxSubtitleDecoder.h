...
#ifndef BERLIN_OMX_SUBTITLE_DECODER_H
#define BERLIN_OMX_SUBTITLE_DECODER_H
...
class OmxSubtitleDecoder :  public OmxComponentImpl{
  public:
    OmxSubtitleDecoder();
    OmxSubtitleDecoder(OMX_STRING name);
    virtual ~OmxSubtitleDecoder();
...
#endif // BERLIN_OMX_SUBTITLE_DECODER_H
