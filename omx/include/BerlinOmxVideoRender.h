...
#ifndef BERLIN_OMX_VIDEO_RENDER_H_
#define BERLIN_OMX_VIDEO_RENDER_H_

#include <BerlinOmxVoutProxy.h>

namespace berlin {
class OmxVideoRender : public OmxVoutProxy {
public:
  OmxVideoRender();
  OmxVideoRender(OMX_STRING name);
  virtual ~OmxVideoRender();
...
#endif // BERLIN_OMX_VIDEO_RENDER_H_
