...
#define PRINT_FLAG(OMX_FLAG) \
  ...
  PRINT_FLAG(OMX_BUFFERFLAG_TIMESTAMPINVALID);
  PRINT_FLAG(OMX_BUFFERFLAG_READONLY);
  PRINT_FLAG(OMX_BUFFERFLAG_ENDOFSUBFRAME);
  PRINT_FLAG(OMX_BUFFERFLAG_SKIPFRAME);
...
OMX_STRING OmxIndex2String(OMX_INDEXTYPE index) {
  switch(index) {
    ...
    STRINGIFY(OMX_IndexReserved_0x0100000E);
    ...
    STRINGIFY(OMX_IndexConfigContentURI);
    STRINGIFY(OMX_IndexConfigCommonPortCapturing);
    ...
    STRINGIFY(OMX_IndexConfigAudio3DOutput);
    STRINGIFY(OMX_IndexConfigAudio3DLocation);
    STRINGIFY(OMX_IndexParamAudio3DDopplerMode);
    STRINGIFY(OMX_IndexConfigAudio3DDopplerSettings);
    STRINGIFY(OMX_IndexConfigAudio3DLevels);
    STRINGIFY(OMX_IndexConfigAudio3DDistanceAttenuation);
    STRINGIFY(OMX_IndexConfigAudio3DDirectivitySettings);
    STRINGIFY(OMX_IndexConfigAudio3DDirectivityOrientation);
    STRINGIFY(OMX_IndexConfigAudio3DMacroscopicOrientation);
    STRINGIFY(OMX_IndexConfigAudio3DMacroscopicSize);
    STRINGIFY(OMX_IndexParamAudioQueryChannelMapping);
    STRINGIFY(OMX_IndexConfigAudioSbcBitpool);
    STRINGIFY(OMX_IndexConfigAudioAmrMode);
    STRINGIFY(OMX_IndexConfigAudioBitrate);
    STRINGIFY(OMX_IndexConfigAudioAMRISFIndex);
    STRINGIFY(OMX_IndexParamAudioFixedPoint);
    ...
    STRINGIFY(OMX_IndexConfigFlickerRejection);
    STRINGIFY(OMX_IndexConfigImageHistogram);
    STRINGIFY(OMX_IndexConfigImageHistogramData);
    STRINGIFY(OMX_IndexConfigImageHistogramInfo);
    STRINGIFY(OMX_IndexConfigImageCaptureStarted);
    STRINGIFY(OMX_IndexConfigImageCaptureEnded);
    ...
    STRINGIFY(OMX_IndexParamNalStreamFormatSupported);
    STRINGIFY(OMX_IndexParamNalStreamFormat);
    STRINGIFY(OMX_IndexParamNalStreamFormatSelect);
    STRINGIFY(OMX_IndexParamVideoVC1);
    STRINGIFY(OMX_IndexConfigVideoIntraPeriod);
    STRINGIFY(OMX_IndexConfigVideoIntraRefresh);
    STRINGIFY(OMX_IndexParamVideoVp8);
    STRINGIFY(OMX_IndexConfigVideoVp8ReferenceFrame);
    STRINGIFY(OMX_IndexConfigVideoVp8ReferenceFrameType);
    ...
    STRINGIFY(OMX_IndexReserved_0x0700002A);
    STRINGIFY(OMX_IndexReserved_0x0700002B);
    STRINGIFY(OMX_IndexConfigCommonTransitionEffect);
    STRINGIFY(OMX_IndexConfigSharpness);
    STRINGIFY(OMX_IndexConfigCommonExtDigitalZoom);
    STRINGIFY(OMX_IndexConfigCommonExtOpticalZoom);
    STRINGIFY(OMX_IndexConfigCommonCenterFieldOfView);
    STRINGIFY(OMX_IndexConfigImageExposureLock);
    STRINGIFY(OMX_IndexConfigImageWhiteBalanceLock);
    STRINGIFY(OMX_IndexConfigImageFocusLock);
    STRINGIFY(OMX_IndexConfigCommonFocusRange);
    STRINGIFY(OMX_IndexConfigImageFlashStatus);
    STRINGIFY(OMX_IndexConfigCommonExtCaptureMode);
    STRINGIFY(OMX_IndexConfigCommonNDFilterControl);
    STRINGIFY(OMX_IndexConfigCommonAFAssistantLight);
    STRINGIFY(OMX_IndexConfigCommonFocusRegionStatus);
    STRINGIFY(OMX_IndexConfigCommonFocusRegionControl);
    STRINGIFY(OMX_IndexParamInterlaceFormat);
    STRINGIFY(OMX_IndexConfigDeInterlace);
    STRINGIFY(OMX_IndexConfigStreamInterlaceFormats);
    ...
    STRINGIFY(OMX_IndexReserved_0x90000003);
    STRINGIFY(OMX_IndexConfigTimeCurrentMediaTime);
    STRINGIFY(OMX_IndexConfigTimeCurrentWallTime);
    STRINGIFY(OMX_IndexReserved_0x09000006);
    STRINGIFY(OMX_IndexReserved_0x09000007);
    ...
    STRINGIFY(OMX_IndexConfigTimeCurrentReference);
    STRINGIFY(OMX_IndexConfigTimeActiveRefClockUpdate);
    STRINGIFY(OMX_IndexConfigTimeRenderingDelay);
    STRINGIFY(OMX_IndexConfigTimeUpdate);

    STRINGIFY(OMX_IndexCommonIndependentStartUnused);
    STRINGIFY(OMX_IndexConfigCommitMode);
    STRINGIFY(OMX_IndexConfigCommit);
    STRINGIFY(OMX_IndexConfigCallbackRequest);
    STRINGIFY(OMX_IndexParamMediaContainer);
    STRINGIFY(OMX_IndexParamReadOnlyBuffers);
