...
TEST_F(OmxDecMultiInstanceTest, mulitToIdleTest) {
  toIdleTest();
}
// TODO: Enable multi dec test when amp side is ready
/*
 TEST_F(OmxDecMultiInstanceTest, mulitDecodeTest) {
 char *compName = "OMX.Marvell.video_decoder.avc";
 testDecode(compName);
 }
 */
