...
LOCAL_MODULE            := OmxAudioRendererTest
...
LOCAL_SRC_FILES         := OmxAudioRendererTest.cpp
...
LOCAL_MODULE_TAGS       := tests
LOCAL_MODULE            := OmxAudTunnelModeTest
...
LOCAL_SRC_FILES         := OmxAudTunnelModeTest.cpp
...
LOCAL_SRC_FILES         := audioPlayerTest.cpp
